...
export function ChatForm({ className, ...props }: React.ComponentProps<"form">) {
  const { append, messages, input, handleInputChange } = useChat({
    api: "/api/chat",
  });
  ...
  const header = (
    <header className="m-auto flex max-w-96 flex-col gap-5 text-center">
      ...
      <p className="text-muted-foreground text-sm">
        This is an AI chatbot app template built with <span className="text-foreground">Next.js</span> and the{" "}
